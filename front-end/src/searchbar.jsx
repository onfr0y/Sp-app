...
function SearchBar() {
  return (
    <div className=" md:resize mt-5 w-full max-w-screen-xl  px-4 sm:px-6 mx-3 mt-5  lg:px-8">
      <div className="relative flex items-center bg-white/70  backdrop-blur-2xl border border-gray-200 dark:border-gray-700 rounded-full shadow-sm hover:shadow-md transition-all duration-200 p-2 sm:p-3 md:p-4">
        <svg
        ...
        <h1 className="ml-2 sm:ml-3 md:ml-4 font-mono text-xs sm:text-sm md:text-base lg:text-lg font-medium">
          Search
        </h1>
      </div>
    </div>
